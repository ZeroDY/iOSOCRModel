...
@interface ViewController : UIViewController<UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIActionSheetDelegate,MAImagePickerControllerDelegate>{
...
- (void)sendAdjustImage:(UIImage *)image;
